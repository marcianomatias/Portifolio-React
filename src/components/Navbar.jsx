  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20'>
            ...
            <a href="#">&lsaquo; M.Matias /&rsaquo;</a>
            ...
            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                ...
                <li><Link to="portifolio" smooth={true} offset={-60} duration={500}>Portfolio</Link></li>
                <li><Link to="contact" smooth={true} offset={-80} duration={500}>About - Contact</Link></li>
            </ul>
            ...
            >
                 <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    ...
                    <li><Link to="portifolio" onClick={closeNav} smooth={true} offset={-60} duration={500}>Portfolio</Link></li>
                    <li><Link to="contact" onClick={closeNav} smooth={true} offset={-80} duration={500}>About - Contact</Link></li>
                   </ul>
